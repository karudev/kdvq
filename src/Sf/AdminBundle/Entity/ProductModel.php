...
class ProductModel {
    ...
    private $material;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Number")
    ...
    */
    ...
    public function setNumber($number = null)
    {
        ...
        $number = str_pad(($this->getNumberEntity() == null ? 0 : $this->getNumberEntity()->getId()),2,"0",STR_PAD_LEFT);
        $this->number = 'P.'.$size.'.'.$color.'.'.$material.'.'.$number.'.'.str_pad($this->getProduct()->getId(),6,"0",STR_PAD_LEFT);
     ...
     * Set numberEntity
     *
     * @param \Sf\AdminBundle\Entity\Number $numberEntity
     * @return ProductModel
     */
    public function setNumberEntity(\Sf\AdminBundle\Entity\Number $numberEntity = null)
    {
     ...
     * Get numberEntity
     *
     * @return \Sf\AdminBundle\Entity\Number 
     */
    public function getNumberEntity()
    {
